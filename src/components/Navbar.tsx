    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Mobile Links */}
          <div className="overflow-y-auto flex-1 px-6 py-8 flex flex-col gap-1">
            {[
              { href: '/', label: 'Home' },
              ...
              <Link
                ...
                className="
                  ...
                  font-semibold text-[var(--primary-black)]/80
                  hover:text-[var(--primary-blue)] hover:bg-[var(--secondary-white)]/70
          ...
          <div className="px-6 pb-10 flex flex-col gap-3">
            ...
            <a
              ...
              className="
                ...
                font-semibold text-[var(--primary-black)]/70
