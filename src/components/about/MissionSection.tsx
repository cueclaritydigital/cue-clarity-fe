...
import { fadeUp, slideInLeft, slideInRight } from "@/lib/animations/variants";
...
export default function MissionSection() {
  return (
    <section className="section-padding px-4 sm:px-6 bg-[var(--primary-blue)] lg:bg-transparent">
      <div className="section-container">
        <div
          className="relative lg:rounded-[4rem] overflow-hidden"
          style={{
