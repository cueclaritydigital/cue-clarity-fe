      ...
      >
        <div className="max-w-[1240px] mx-auto px-5 sm:px-6 h-[72px] flex items-center justify-between gap-8">
          ...
          <Link
            ...
            className="flex items-center gap-2 shrink-0 focus-visible:outline-none transform scale-130 lg:scale-170"
          >
            <Logo />
          </Link>
          ...
          <nav aria-label="Main Navigation" className="hidden lg:flex items-center">
            <ul
              className="flex items-center gap-1 text-[var(--primary-black)] text-[14px]"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="
                ...
                hover:bg-[var(--accent-yellow)] hover:-translate-y-px hover:shadow-[0_8px_28px_rgba(255,193,20,0.4)]
                transition-all duration-200
              "
