...
import { FiBookOpen, FiCompass, FiTarget, FiBriefcase, FiArrowRight, FiCheck } from 'react-icons/fi';
...
const SEGMENTS = [
  {
    ...
    points: ['Subject & stream exploration', 'Aptitude discovery', 'Parent-aligned guidance'],
  ...
  },
  {
    ...
    points: ['Entrance exam roadmap', 'University shortlisting', 'Application strategy'],
    accent: '#D97706',
  ...
  },
  {
    ...
    points: ['Internship planning', 'Resume & interview prep', 'Post-grad pathways'],
    accent: '#059669',
  ...
  },
  {
    ...
    points: ['Career transition maps', 'Strategic upskilling', 'Leadership pathways'],
    accent: '#6D28D9',
...
export default function WhoWeHelp() {
  return (
    <section className="section-padding px-4 sm:px-6 section-container" style={{ backgroundColor: 'var(--primary-white)' }}>
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,360px)_1fr] gap-12 lg:gap-20 items-start">
          ...
          <FadeInView className="lg:sticky lg:top-28 flex flex-col gap-6">
            <span className="type-eyebrow" style={{ color: 'var(--accent-blue)' }}>Who We Help</span>
            ...
            >
              Every Stage.<br />
              <span style={{ color: 'var(--primary-blue)' }}>Every Person.</span>
            </h2>
            ...
            >
              Personalised guidance for students, families, and professionals at every turning point.
            </p>

            {/* Stat divider */}
            <div className="py-6 border-t border-b" style={{ borderColor: 'rgba(12,21,24,0.08)' }}>
              <p
                style={{
                  fontFamily: 'var(--font-oswald)',
              ...
              >2,000+</p>
              <p className="type-label mt-1.5" style={{ color: 'var(--muted-text)' }}>Careers Transformed</p>
            </div>

            <a
              href="/services"
              className="inline-flex items-center gap-2 font-bold group/link w-fit"
              style={{ fontSize: 'var(--text-sm)', color: 'var(--primary-blue)', letterSpacing: 'var(--tracking-wide)' }}
            >
              ...
              >
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ color: 'var(--muted-text)', fontSize: 'var(--text-sm)' }}
                  >
                    {s.desc}
                  </p>
                </div>
                ...
                {/* 3-point bullets */}
                <ul className="flex flex-col gap-2 mt-auto pt-4" style={{ borderTop: '1px solid rgba(12,21,24,0.06)' }}>
                  {s.points.map((pt) => (
                    <li
                      key={pt}
                      className="flex items-center gap-2"
                      style={{ fontSize: 'var(--text-xs)', color: 'var(--muted-text)', fontWeight: 500 }}
                    >
                      <FiCheck size={11} style={{ color: s.accent, flexShrink: 0 }} />
                      {pt}
                    </li>
                  ))}
                </ul>
